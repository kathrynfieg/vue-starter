...
<template>
  <div
    class="relative flex aspect-square w-full flex-col overflow-hidden rounded-md border border-stone-200 bg-white p-1.5"
  >
    <List
      class="absolute right-0.5 top-0.5 size-3 text-stone-400 sm:size-3.5"
      :stroke-width="1.5"
      aria-hidden="true"
    />
